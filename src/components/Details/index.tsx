  ...
  return (
    <div className="product-details">
      <div className="gallery">
        <div className="imageBig" onClick={() => setShowModal(true)}>
          <img src={bigImageMap[activeImage]} alt="imageBig" />
        </div>
        <div
      ...
      <div className="details">
        <p className="pre-heading">Sneaker Company</p>
        ...
        <div className="button-container">
          <Quantity num={num} setNum={setNum} />
          <Button
            onClick={() => {
              setQuantity(num);
            }}
